...
public class AssignmentSignupPage3 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@id='name']")).sendKeys("Pragna");
		Thread.sleep(2000);
		
		driver.findElement(By.xpath("//input[@id='email']")).sendKeys("saipragna@gmail.com");
		Thread.sleep(1000);
